...
function QuoteShare() {
  ...
  return (
    ...
    >
      <div className="flex gap-1 border border-ink bg-ink p-1 shadow-edge">
        <button
          onClick={() => handleShare('twitter')}
          className="p-2 transition-colors hover:bg-tile"
          title="Share on Twitter"
        >
          <svg className="h-4 w-4 text-paper" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          title="Copy quote"
        >
          <svg className="h-4 w-4 text-paper" fill="none" stroke="currentColor" viewBox="0 0 24 24">
