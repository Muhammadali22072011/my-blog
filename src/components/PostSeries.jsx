...
function PostSeries({ currentPostId, posts, seriesTag }) {
  ...
  return (
    <div className="bg-paper-deep dark:from-purple-900/20 dark:to-blue-900/20 rounded p-6 my-8 border border-purple-200 dark:border-purple-800">
      <div className="flex items-center gap-2 mb-4">
        <svg className="w-5 h-5 text-tile dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          return (
            ...
            >
              <span className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold ${
                isCurrent 
                  ? 'bg-white/20' 
                  : 'bg-purple-100 dark:bg-purple-900/50 text-tile dark:text-purple-400'
              }`}>
                {index + 1}
              </span>
      ...
      <div className="flex justify-between mt-4 pt-4 border-t border-purple-200 dark:border-purple-800">
        {currentIndex > 0 ? (
          <Link
            ...
            className="flex items-center gap-1 text-sm text-tile dark:text-purple-400 hover:underline"
          >
