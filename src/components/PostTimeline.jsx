        ...
        {timeline.map((group, groupIndex) => (
          <div key={`${group.year}-${group.month}`} className="relative">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-paper-deep text-white px-4 py-2 rounded-full font-bold text-sm">
                {group.month} {group.year}
              </div>
              <div className="flex-1 h-px bg-paper-deep dark:from-gray-700"></div>
            </div>
            <div className="space-y-3 ml-4 border-l-2 border-gray-200 dark:border-gray-700 pl-6">
              {group.posts.map((post, postIndex) => (
                ...
                >
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded p-4 hover:bg-gray-100 dark:hover:bg-gray-600 transition-all">
